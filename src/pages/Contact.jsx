      ...
      <section className="section-padding">
        <div className="container" style={{ maxWidth: '1200px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '3rem' }}>
            ...
            {/* Two-Column Section: Left Info, Right Form */}
            <div className="hitec-contact-desktop-grid">
              
              {/* LEFT SIDE: Office / Contact Information */}
              <div 
              ...
              >
                <div>
                  <h3 className="card-title" style={{ fontSize: '1.6rem', marginBottom: '2rem', color: 'var(--color-dark)' }}>Office Information</h3>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '1.75rem' }}>
                    <div style={{ display: 'flex', gap: '1.25rem', alignItems: 'start' }}>
                      ...
                      <div>
                        <h4 style={{ fontSize: '1.05rem', fontWeight: 700, color: 'var(--color-dark)' }}>Headquarters Address</h4>
                    ...
                    <div style={{ display: 'flex', gap: '1.25rem', alignItems: 'start' }}>
                      ...
                      <div>
                        <h4 style={{ fontSize: '1.05rem', fontWeight: 700, color: 'var(--color-dark)' }}>Phone Call Contacts</h4>
                    ...
                    <div style={{ display: 'flex', gap: '1.25rem', alignItems: 'start' }}>
                      ...
                      <div>
                        <h4 style={{ fontSize: '1.05rem', fontWeight: 700, color: 'var(--color-dark)' }}>Email Address</h4>
                        <p style={{ fontSize: '0.95rem', color: 'var(--color-text-muted-dark)', marginTop: '0.4rem' }}>
                    ...
                    <div style={{ display: 'flex', gap: '1.25rem', alignItems: 'start' }}>
                      ...
                      <div>
                        <h4 style={{ fontSize: '1.05rem', fontWeight: 700, color: 'var(--color-dark)' }}>Operational Hours</h4>
                        <p style={{ fontSize: '0.95rem', color: 'var(--color-text-muted-dark)', marginTop: '0.4rem' }}>{contact.hours}</p>
                      </div>
                    </div>

                    {/* GSTIN Field */}
                    <div style={{ display: 'flex', gap: '1.25rem', alignItems: 'start', borderTop: '1px solid var(--color-light-border)', paddingTop: '1.75rem', marginTop: '0.75rem' }}>
                      <div style={{ color: 'var(--color-primary)', marginTop: '3px' }}><ShieldCheck size={22} /></div>
                      <div>
                        <h4 style={{ fontSize: '1.05rem', fontWeight: 700, color: 'var(--color-dark)' }}>GST Registration Details</h4>
              ...
              {/* RIGHT SIDE: Send Us a Query Form */}
              <div 
                className="premium-card" 
                style={{ 
                  padding: '3rem', 
              ...
              >
                <div>
                  <h3 className="card-title" style={{ fontSize: '1.6rem', marginBottom: '2rem', color: 'var(--color-dark)' }}>Send Us a Query</h3>
            ...
            {/* Location Map: Large Full-Width Section */}
            <div 
              className="premium-card" 
              style={{ 
                padding: 0, 
            ...
            >
              <div style={{ width: '100%', height: '480px', position: 'relative', backgroundColor: '#eeeeee' }}>
                <iframe 
              ...
              <div style={{ padding: '1.75rem 2.5rem', borderTop: '1px solid var(--color-light-border)', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '1.5rem', backgroundColor: 'var(--color-light-bg)' }}>
                <div style={{ fontSize: '0.95rem', color: 'var(--color-text-muted-dark)', maxWidth: '500px' }}>
                  <strong>Hitec Innovations Location Map</strong><br />
                  {contact.address} (Near St. Joseph Convent Boarding, Mission Quarters, Thrissur)
                </div>
                <a 
                  ...
                  style={{ padding: '0.6rem 1.5rem', fontSize: '0.85rem', display: 'inline-flex', alignItems: 'center', gap: '0.35rem', whiteSpace: 'nowrap' }}
                >
